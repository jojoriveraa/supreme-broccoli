...
public class OrderController {
	...
	@PostMapping("/create")
	private Order create(HttpServletResponse response) {
		response.setStatus(HttpServletResponse.SC_CREATED);
		return manager.createNewOrder();
	}

	@GetMapping("/{id}")
	private Order get(@PathVariable("id") int id, HttpServletResponse response) {
	...
	@DeleteMapping("/{id}")
	private void delete(@PathVariable("id") int id, HttpServletResponse response) {
	...
	private Order add(@PathVariable("id") int id, @PathVariable("coffeeType") String coffeeType,
	...
	private Order remove(@PathVariable("id") int id, @PathVariable("itemIndex") int index,
